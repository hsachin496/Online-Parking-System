	...
	class ParkingSystem {
	    ...
	    public void displayBookings(String username) {
	        ...
	        if (userBookings.isEmpty()) {
	            ...
	            for (ParkingSpot spot : userBookings) {
	                System.out.println("Slot Number: " + spot.getSpotNumber());
	            }
	        }
	    }
	    ...
	    public boolean bookParkingSpot(String username, int spotNumber) {
	        ...
	        if (!spotToBook.isAvailable()) {
	            System.out.println("Slot " + spotNumber + " is already booked. Please choose another spot.");
	            return false;
	        }
	        ...
	        System.out.println("Booking successful! You have booked slot number " + spotNumber + ".");
	        return true;
	    }
	    ...
	    public boolean releaseParkingSpot(String username, int spotNumber) {
	        ...
	        if (spotToRelease == null) {
	            System.out.println("You have not booked the specified slot.");
	            return false;
	        }
